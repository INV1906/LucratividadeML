...
CREATE TABLE `custos` (
  ...
  `taxa_fixa_list` decimal(10,2) DEFAULT NULL,
  `valor_bruto_comissao` decimal(10,2) DEFAULT NULL,
  `tipo` varchar(10) DEFAULT NULL,
  `custos` decimal(10,2) DEFAULT NULL,
  `taxa_fixa_sale` decimal(10,2) DEFAULT NULL,
  `bruto_comissao` decimal(10,2) DEFAULT NULL,
  `porcentagem_da_comissao` int DEFAULT NULL,
  `imposto` decimal(10,2) DEFAULT NULL,
  `embalagem` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `custos` VALUES (1,'MLB3335809051',0.00,0.00,'Premium',17.73,6.75,17.73,19,14.00,1.00,20.00,0.00);
